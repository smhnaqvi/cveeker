	...
	users := []models.UserModel{
		{
			...
			Experience: "5 years in web development and team leadership",
			Skills:     "Go, JavaScript, React, Python, Docker, Kubernetes",
		...
		},
		{
			...
			Experience: "7 years in full-stack development and system architecture",
			Skills:     "Java, Spring, Angular, React, Docker, AWS, Microservices",
		...
		},
		{
			...
			Phone:      "+1555123456",
			Summary:    "DevOps Engineer specializing in Cloud Infrastructure",
			Education:  "BS Information Technology from UC Berkeley",
			Experience: "4 years in DevOps, Cloud Computing, and Infrastructure Automation",
			Skills:     "AWS, Azure, Kubernetes, Terraform, Jenkins, CI/CD, Python",
			Languages:  "English (Native)",
			Location:   "Austin, TX",
			Website:    "https://mikejohnson.cloud",
